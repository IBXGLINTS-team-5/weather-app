    ...
    data ${data.name}`)
        ...
        const weatherHTML = `
            <div class="col text-center">
                ...
                <p>overview of today's weather ${data.weather[0].description} with a minimum temperature ${data.main.temp_min} and maximum temperature ${data.main.temp_max} at wind speed ${data.wind.speed} km/h<p>
